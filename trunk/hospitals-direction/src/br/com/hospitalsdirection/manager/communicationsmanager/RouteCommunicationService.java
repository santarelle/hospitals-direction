...
public abstract  class RouteCommunicationService extends ServiceRequest<Route> implements IRouteCommunicationService{

	
	public RouteCommunicationService(final Context context) {
		setContext(context);
		setEntryTime(0);
	}
