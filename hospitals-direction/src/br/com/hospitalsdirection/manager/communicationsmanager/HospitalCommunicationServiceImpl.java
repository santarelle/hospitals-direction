...
@ContextSingleton
public abstract class HospitalCommunicationServiceImpl extends ServiceRequest<Hospital> implements HospitalCommunicationService {
	...
	public HospitalCommunicationServiceImpl(final Context context) {
		setContext(context);
		setEntryTime(0);
	}
